...
const Features = () => {
  return (
    <div id="features" className="pb-12">
      <div className="container px-4 w-3/4 mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-10">
          <div
            className={`p-2 h-full hover:shadow-md rounded-3xl ${"md:col-span-1 md:row-span-3"}`}
          >
          ...
          <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 row-span-3 w-full">
            <div
              className={`p-2 min-h-[20rem] hover:shadow-md rounded-3xl col-span-1 row-span-3 w-full`}
            >
              <div className="p-4 rounded-2xl h-full relative group overflow-hidden flex flex-col bg-background border border-border/60 max-h-full hover:border-accent transition-all">
                <div className="bottom-[-5rem] group-hover:opacity-30 dark:group-hover:opacity-80 opacity-0 right-[-20rem] z-[1] absolute bg-gradient-to-t from-primary to-purple-800/20 blur-[5em] rounded-xl transition-all translate-x-[-50%] duration-700 ease-out size-[20rem] rotate-[40deg]"></div>
                <div className="absolute w-full h-full -top-[20%] -left-[35%] md:-left-[35%]">
            ...
            <div
              className={`p-2 min-h-[20rem] hover:shadow-md rounded-3xl md:col-span-1 md:row-span-3 w-full`}
            >
              <div className="p-4 rounded-2xl h-full relative group overflow-hidden flex flex-col bg-background border border-border/60 max-h-full hover:border-accent transition-all">
                <div className="bottom-[-5rem] group-hover:opacity-30 dark:group-hover:opacity-80 opacity-0 right-[-20rem] z-[1] absolute bg-gradient-to-t from-primary to-purple-800/20 blur-[5em] rounded-xl transition-all translate-x-[-50%] duration-700 ease-out size-[20rem] rotate-[40deg]"></div>
                <div className="absolute w-full h-full -top-[20%] -left-[35%] md:-left-[35%]">
            ...
            <div
              className={`p-2 min-h-[20rem] hover:shadow-md rounded-3xl md:col-span-2 md:row-span-3 w-full`}
            >
              <div className="p-4 rounded-2xl h-full relative group overflow-hidden flex flex-col bg-background border border-border/60 max-h-full hover:border-accent transition-all">
                <div className="bottom-[-5rem] group-hover:opacity-30 dark:group-hover:opacity-80 opacity-0 right-[-20rem] z-[1] absolute bg-gradient-to-t from-primary to-purple-800/20 blur-[5em] rounded-xl transition-all translate-x-[-50%] duration-700 ease-out size-[20rem] rotate-[40deg]"></div>
                <div className="absolute w-full h-full -top-[20%] -left-[35%] md:-left-[35%]">
